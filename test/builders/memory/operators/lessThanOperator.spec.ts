import {LessThanOperator} from "../../../../src/builders/memory/operators/lessThanOperator";
...
describe('lessThanOperator', () => {
    it('should return false when field type is number and null', () => {
        ...
        const expression = LessThanOperator.build(FieldType.FieldTypeNumber, 'Value', null);
    ...
    it('should return false when field type is date and null', () => {
        ...
        const expression = LessThanOperator.build(FieldType.FieldTypeDate, 'Value', null);
    ...
    it('should return true when field type is date and less', () => {
        ...
        const expression = LessThanOperator.build(FieldType.FieldTypeDate, 'Value', new Date(value.getTime() + 24 * 60 * 60 * 1000));
    ...
    it('should return false when field type is time and null', () => {
        ...
        const expression = LessThanOperator.build(FieldType.FieldTypeTime, 'Value', null);
    ...
    it('should return false when field type is datetime and null', () => {
        ...
        const expression = LessThanOperator.build(FieldType.FieldTypeDateTime, 'Value', null);
    ...
    it('should return true when field type is datetime and less', () => {
        ...
        const expression = LessThanOperator.build(FieldType.FieldTypeDateTime, 'Value', new Date(value.getTime() + 24 * 60 * 60 * 1000));

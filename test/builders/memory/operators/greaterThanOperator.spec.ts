import {GreaterThanOperator} from "../../../../src/builders/memory/operators/greaterThanOperator";
...
describe('greaterThanOperator', () => {
    it('should return false when field type is number and null', () => {
        ...
        const expression = GreaterThanOperator.build(FieldType.FieldTypeNumber, 'Value', null);
    ...
    it('should return false when field type is number and less', () => {
        ...
        const expression = GreaterThanOperator.build(FieldType.FieldTypeNumber, 'Value', value + 1);
    ...
    it('should return false when field type is number and equal', () => {
        // Arrange
        const value = 100;
        const data = {
            Value: <number | null>value
    ...
    it('should return false when field type is date and null', () => {
        ...
        const expression = GreaterThanOperator.build(FieldType.FieldTypeDate, 'Value', null);
    ...
    it('should return false when field type is date and less', () => {
        ...
        const expression = GreaterThanOperator.build(FieldType.FieldTypeDate, 'Value', new Date(value.getTime() + 24 * 60 * 60 * 1000));
    ...
    it('should return false when field type is date and equal', () => {
        // Arrange
        const value = new Date();
        const data = {
            Value: <Date | null>value
    ...
    it('should return false when field type is time and null', () => {
        ...
        const expression = GreaterThanOperator.build(FieldType.FieldTypeTime, 'Value', null);
    ...
    it('should return false when field type is time and less', () => {
        ...
        const expression = GreaterThanOperator.build(FieldType.FieldTypeTime, 'Value', value + 1);
    ...
    it('should return false when field type is time and equal', () => {
        // Arrange
        const value = 60;
        const data = {
            Value: <number | null>value
    ...
    it('should return false when field type is datetime and null', () => {
        ...
        const expression = GreaterThanOperator.build(FieldType.FieldTypeDateTime, 'Value', null);
    ...
    it('should return false when field type is datetime and less', () => {
        ...
        const expression = GreaterThanOperator.build(FieldType.FieldTypeDateTime, 'Value', new Date(value.getTime() + 24 * 60 * 60 * 1000));
    ...
    it('should return false when field type is datetime and equal', () => {
        // Arrange
        const value = new Date();
        const data = {
            Value: <Date | null>value
